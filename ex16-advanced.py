...
def main(X_train, X_test, y_train, y_test):
    ...
    for i, test_item in enumerate(X_test):
        ...
        # sort the training points by distance(get indices in sorted order)
        ...
        # predict based on majority vote using the hint
        y_predict[i] = np.round(np.mean(k_nearest_labels))

        # create a line connecting the test point to the nearest neighbor for visualization
